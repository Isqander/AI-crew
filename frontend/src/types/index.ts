...
export const AGENTS: Record<AgentName, AgentInfo> = {
  pm: {
    name: 'pm',
    displayName: 'agents.pm',
    description: 'agents.pmDesc',
    color: 'cyan',
  },
  analyst: {
    name: 'analyst',
    displayName: 'agents.analyst',
    description: 'agents.analystDesc',
    color: 'magenta',
  },
  architect: {
    name: 'architect',
    displayName: 'agents.architect',
    description: 'agents.architectDesc',
    color: 'lime',
  },
  developer: {
    name: 'developer',
    displayName: 'agents.developer',
    description: 'agents.developerDesc',
    color: 'amber',
  },
  reviewer: {
    name: 'reviewer',
    displayName: 'agents.reviewer',
    description: 'agents.reviewerDesc',
    color: 'violet',
  },
  qa: {
    name: 'qa',
    displayName: 'agents.qa',
    description: 'agents.qaDesc',
    color: 'teal',
  },
  security: {
    name: 'security',
    displayName: 'agents.security',
    description: 'agents.securityDesc',
    color: 'red',
  },
  lint_check: {
    name: 'lint_check',
    displayName: 'agents.lintCheck',
    description: 'agents.lintCheckDesc',
    color: 'orange',
  },
  ci_check: {
    name: 'ci_check',
    displayName: 'agents.ciCheck',
    description: 'agents.ciCheckDesc',
    color: 'blue',
  },
  git_commit: {
    name: 'git_commit',
    displayName: 'agents.gitCommit',
    description: 'agents.gitCommitDesc',
    color: 'green',
  },
  waiting_for_user: {
    name: 'waiting_for_user',
    displayName: 'agents.waitingForUser',
    description: 'agents.waitingForUserDesc',
    color: 'amber',
  },
  complete: {
    name: 'complete',
    displayName: 'agents.complete',
    description: 'agents.completeDesc',
    color: 'lime',
  },
}
