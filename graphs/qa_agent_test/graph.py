...
DEFAULT_WEB_APP_TASK = (
    "Создай простейшее веб-приложение с UI для проверки QA.\n"
    "Требования:\n"
    "1) Стек: HTML + CSS + JavaScript (без сложных фреймворков).\n"
    "2) Файлы: index.html, styles.css, app.js.\n"
    "3) UI: заголовок, текстовое поле, кнопка, блок результата.\n"
    "4) Поведение: по кнопке выводить текст из поля в блок результата.\n"
    "5) Код должен запускаться локально и быть удобным для визуальной проверки."
)
